...
| W4-2 | **Started, 2026-09-02** — see §31. `derive-numbers` and `place-sibling` moved; they imported nothing. `schedule.ts` and the rest need the row-type mapping first.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   | `apps/be-01/src/service/{schedule,dependency,derive-numbers,place-sibling,assumed-assignee}.ts` → `libs/domain/src/`, `revision.ts`                       | 2d     | W4-1                         |
