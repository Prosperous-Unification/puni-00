# Twilight Burokrat and k3s Fleet Implementation Plan
...
**Goal:** Publish `twilight-burokrat` as an independently installable npm package, consume it in CI/CD, and deliver Ansible-managed k3s infrastructure that supports nodes joining, leaving and being replaced.
...
**Spec:** [Delivery contract](../specs/2026-09-17-twilight-burokrat-and-fleet-design.md).
...
| ------------------------------------------------------------ | ------ | -------------------------------- | --------------------------------------------------------------------------------------------------------- |
| [Package and CI/CD](2026-09-17-twilight-burokrat-package.md) | P0–P5  | Synced baseline                  | Standalone tested tarball, registry release workflow, consumer adoption with preserved trust              |
...
P0 creates `twilight-burokrat-package` and `twilight-burokrat-consumer`.
...
```sh
bunx @fission-ai/openspec@1.12.0 new change twilight-burokrat-package
bunx @fission-ai/openspec@1.12.0 status --change twilight-burokrat-package --json
bunx @fission-ai/openspec@1.12.0 instructions intent --change twilight-burokrat-package --json
```
...
[pkg]: ../../../openspec/changes/twilight-burokrat-package/verify.md
[consumer]: ../../../openspec/changes/twilight-burokrat-consumer/verify.md
