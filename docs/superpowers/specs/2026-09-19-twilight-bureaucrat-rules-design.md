# Twilight Bureaucrat rules design

Status: proposed design, 2026-09-19. Nothing here is implemented. It extends the existing
[Twilight Bureaucrat package](../../../apps/wiki/cli/README.md) from a wiki ledger validator
...
**Outcome.** Twilight Bureaucrat answers one question for any artifact: is this allowed and
...
Dash instantiates a template; Twilight Bureaucrat verifies the result. Because both read the
same template, a generator and its validator cannot drift.

## Gates along the work request flow

Twilight Navigator and Twilight Dash move the work. Twilight Bureaucrat gates each stage's
...
| OpenSpec structure                              | The OpenSpec command in the gate | Read as recorded output; Bureaucrat adds what it cannot express  |
