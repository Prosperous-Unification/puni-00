...
| TS-34 | Commit work frequently, merge checked increments to main and deploy to the shared development environment as often as possible so Dany can observe the actual work there. Run scheduled manual browser-test sweeps against shared dev. Added 2026-09-08.                                                                                                                                                 |
