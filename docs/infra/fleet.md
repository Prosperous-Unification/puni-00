...
tool-fleet:lab, tool-fleet:plan, and tool-fleet:apply fail with their missing
phase prerequisite until F3, F1, and F4 respectively supply the real
implementation. They never report success as placeholders.
