...
ssh h2puni \
  "flock /home/puni1/wbs-dev/state/poll.lock bash -c 'git -C /home/puni1/wbs-dev/src fetch --quiet origin && bash -s -- /home/puni1/wbs-dev/src /home/puni1/wbs-dev/bin /home/puni1/wbs-dev/bin/bun $SHA $BUN_VERSION && printf \\"%s\\\\n\\" $SHA > /home/puni1/wbs-dev/state/last-synced.manual && mv /home/puni1/wbs-dev/state/last-synced.manual /home/puni1/wbs-dev/state/last-synced && rm -f /home/puni1/wbs-dev/state/awaiting-recreate'" \
