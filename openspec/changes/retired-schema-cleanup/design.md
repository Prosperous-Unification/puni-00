...
| write (this release)          | —                                                            | none — the scalar write came off the patch line when the set landed (`work-item.ts:373`); only `work_item_service` is written (`work-item.ts:568-573`, `:678-680`)                                             |
