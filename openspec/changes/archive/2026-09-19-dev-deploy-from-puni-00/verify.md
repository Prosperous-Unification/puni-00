...
- Exact-head repair proof on h2puni: **73 passed, 0 failed, 221 assertions**, followed by focused ESLint with no errors. The affected CI project passed; the run's only failures were five unrelated Twilight Burokrat production-CLI tests exceeding their fixed 5-second/20-second timeout limits.
