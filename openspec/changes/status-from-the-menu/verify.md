...
| the menu offers the mark                       | the entry dropped from `createActionsColumn`   | plan-structure › `marks a row done from its ⋯ menu…`                   | `Unable to find … role "menuitem" and name "Mark done…"` |
