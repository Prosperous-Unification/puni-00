...
| Check                     | Injected fault                                                   | Observed failure                                                                                                                                  |
| ------------------------- | ---------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------- |
| Same-command move source  | Delegated `moveAll` without refreshing either endpoint.          | The production runner's post-`moveAll` reads retained the source in all four collections before another store call.                               |
