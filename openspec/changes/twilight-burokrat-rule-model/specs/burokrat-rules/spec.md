...
- **THEN** Twilight Burokrat prints the rule's registry record
...
- **WHEN** Twilight Burokrat loads the policy
...
- **WHEN** Twilight Burokrat loads the policy before an adopted set exists
...
- **THEN** Twilight Burokrat prints one allowed verdict
...
- **WHEN** Twilight Burokrat prints its verdict
...
Twilight Burokrat SHALL enforce this statement as the module-index declaration rule.
...
Twilight Burokrat SHALL enforce this statement as the module-index direct-entry rule.
...
Twilight Burokrat SHALL enforce this statement as the inventory-classification rule.
...
Twilight Burokrat SHALL enforce this statement as the relationship-resolution rule.
...
- **THEN** Twilight Burokrat prints the rule record, policy identifier, and stated mode
