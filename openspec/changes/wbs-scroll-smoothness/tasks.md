...
- [ ] 2.4 Keep the current linear `placeRows` and immediate height readings: each measured below 5% of 2,000-row task time. Reconsider them only with new traces above the cutoff. Keep complete Gantt rendering but isolate it per 2.2; windowing remains out of scope.
