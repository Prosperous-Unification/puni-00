...
- **THEN** the first reports `status: 'unknown'` for that term with its earlier terms intact, the second reports `publication: 'quantisation-floor'`, and neither is presented as a proved solver win
