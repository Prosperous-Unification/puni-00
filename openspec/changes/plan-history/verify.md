...
that project was inserted by hand *after* the band migration ran, so the seeding
never saw it.)

## The gate

Run on **h2puni** over plain ssh at head `1a5c49f`, in
