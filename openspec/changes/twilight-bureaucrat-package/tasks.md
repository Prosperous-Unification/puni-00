...
- [x] P4 — Transfer and release exactly the tested artifact per [P4](../../../docs/superpowers/plans/2026-09-17-twilight-bureaucrat-package.md#p4--release-exactly-the-package-that-was-tested). Publication is prepared and remains pending the external license, registry ownership, protected environment, token, and release tag.
