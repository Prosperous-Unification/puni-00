...
The Twilight Burokrat fast-forward workflow MUST traverse design before declaring planning
...
against the Twilight Burokrat schema in a disposable repository. That check MUST NOT be
...
- **WHEN** the design dependency is removed from the Twilight Burokrat schema
