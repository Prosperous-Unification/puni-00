...
**Change**: `twilight-burokrat-short-command`
...
| ----------------------------------------------------------------------------- | ---- | -------------------------------------------------------------------------------------- |
| Baseline `NX_DAEMON=false bunx nx run twilight-burokrat:pack --skip-nx-cache` | 0    | `Successfully ran target pack for project twilight-burokrat and 1 task it depends on`  |
...
| `NX_DAEMON=false bunx nx run twilight-burokrat:typecheck`                     | 0    | `Successfully ran target typecheck for project twilight-burokrat`                      |
| `NX_DAEMON=false bunx nx run twilight-burokrat:lint:source`                   | 0    | `Successfully ran target lint:source for project twilight-burokrat`                    |
| `NX_DAEMON=false bunx nx run twilight-burokrat:build`                         | 0    | `Successfully ran target build for project twilight-burokrat`                          |
...
- `NX_DAEMON=false bunx nx run twilight-burokrat:test:package` — planner-only whole package target after staging.
