...
Install a pinned Twilight Burokrat release from trusted base-owned inputs with scripts disabled, use it across every current consumer path, and bind deployment admission to source, package, activation, and image identities.
