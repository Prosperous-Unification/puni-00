...
Slices 1.1–1.4, 2.1–2.3 and 3.1–3.4 are complete. 4.1 is the only open slice, and every
...
Every pass/fail count below is **as observed when that row was watched**, so the totals differ
between rows: cases were added to both suites across three rounds, and two rows were
