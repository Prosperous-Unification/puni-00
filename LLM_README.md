...
| `libs/shared/domain/validation`; `libs/shared/domain/failures`                                                                                                                                                                                         | framework-free ArkType parse helpers every product and tool may import (`@shared/validation`), plus one shared reporting policy every product and tool may import (`@shared/failures`); infra aliases are `@tools/*`                                   |
