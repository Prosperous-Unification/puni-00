...
TASK-326 is on `change/task-326-dev-solver-binding`: automatic binding and missing-config bootstrap are implemented; next exercise a real solver-changing poll tick, then run prod review and CI.
