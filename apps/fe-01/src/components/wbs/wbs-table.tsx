    ...
    <>
      ...
      */}
      ...
      <PhasesDialog
        ...
        // How far a dependency reaches, on the same surface as the steps it is
        // about: reordering them moves what an `anchor-slice` dependency waits
        // for. Off the chart read rather than a state of its own, so the value
        // ticked here and the reach the arrows were drawn with are one fact.
        depReach={chartRead.depReach}
        setDepReach={(reach) => api.setDepReach(projectId, reach)}
