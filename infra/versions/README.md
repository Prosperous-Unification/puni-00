...
consume checksum-verified chart archives vendored under `infra/platform/charts`
through the immutable Flux Git source and carry every enabled image digest from
the chart lock. The
