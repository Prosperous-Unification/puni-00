...
export interface PackageIdentity {
  readonly name: 'twilight-burokrat';
...
/**
 * The record `infra/ci/burokrat/admit.sh` writes to `<scratch>/admission.json` after the
...
export function parseTrustedAdmission(input: unknown): TrustedAdmission {
  // Proof: burokrat-consumer.test.ts removed the activation and then the package shape check;
